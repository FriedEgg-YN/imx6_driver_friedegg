# Project specific details for imx6_driver_friedegg

Canonical Codex instructions live in `AGENTS.md`. Keep this file aligned with
that policy when using GitHub Copilot.
...
- Kernel/U-Boot: Source maintained in `/src/linux-friedegg/` and `/src/uboot-friedegg/`.
...
- src/linux-friedegg: Linux kernel 4.1.15, 在 NXP 官方基础上进行移植
- src/uboot-friedegg: U-Boot 2016.11, 同样基于 NXP 官方版本
